...
const ChangePassword = () => {
    ...
    const requestOTP = () => {
        axios.get(`http://exchange-btc.in:8080/api/client/auth/requestOtp/${passwordData.phoneNumber}`)
            .then(response => {
    ...
    const changePassword = (e) => {
        e.preventDefault();
        axios.post('http://exchange-btc.in:8080/api/client/auth/changePassword/', {
